        ...
        if (data === undefined && elem.nodeType === 1) {
            ...
            if (typeof data === 'string') {
                try {
                    ...
                    +data + '' === data ? +data : rbrace.test(data) ? JSON.parse() : data;
                } catch (e) {
                }
    ...
    Tween.prototype = {
        ...
        run: function (percent) {
            ...
            if (this.options.step) {
                this.options.step.call(this.elem, this);
            }
            if (hooks && hooks.set) {
                hooks.set(this);
            } else {
        ...
        propHooks: {
            tabIndex: {
                get: function (elem) {
                    ...
                    return tabindex ? parseInt(tabindex) : rfocusable.test(elem.nodeName) || rclickable.test(elem.nodeName) && elem.href ? 0 : -1;
                }
            }
        },
        propFix: {
