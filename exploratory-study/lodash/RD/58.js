   ...
   */
     ...
     */
        function cacheIndexOf(cache, value) {
            var data = cache.data, result = typeof value == 'string' || isObject(value) ? data.set.has() : data.hash[value];
            return result ? 0 : -1;
        }
        /**
     ...
     */
        function mergeData(data, source) {
            ...
            if (value) {
                partials = data[5];
                data[5] = partials ? composeArgsRight(partials, value) : copyArray(value);
