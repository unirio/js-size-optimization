   ...
   */
        ...
        function createHybridWrapper(func, bitmask, thisArg, partials, holders, partialsRight, holdersRight, argPos, ary, arity) {
            ...
            function wrapper() {
                ...
                if (isCurry || isCurryRight) {
                    ...
                    if (length < arity) {
                        var newArgPos = argPos ? copyArray() : undefined, newArity = nativeMax(arity - length, 0), newsHolders = isCurry ? argsHolders : undefined, newHoldersRight = isCurry ? undefined : argsHolders, newPartials = isCurry ? args : undefined, newPartialsRight = isCurry ? undefined : args;
     ...
     */
        function template(string, options, otherOptions) {
            ...
            if (otherOptions && isIterateeCall(string, options)) {
