...
function handleFile(item, index) {
	...
	var contentsOriginal = fs.readFileSync(baseDir + "\\GA\\original.js", "utf8");
	
	for (var i = 0; i < rounds; i++) {
		console.log(item + "-" + i + " ...");
		var contentsVariant = fs.readFileSync(baseDir + "\\GA\\" + i + ".js", "utf8");
...
function writeTopmostFile() {
	...
	fs.writeFileSync("results\\topmost-count-unrestricted-patch.csv", result, 'utf8');
}
