...
(function () {
   ...
   */
    ...
    var EXP_LIMIT = 9000000000000000,
        ...
        }, quadrant, external = true, decimalError = '[DecimalError] ', mathfloor = Math.floor, mathpow = Math.pow, isBinary = /^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i, isHex = /^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i, isOctal = /^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i, isDecimal = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, BASE = 10000000, LOG_BASE = 7, MAX_SAFE_INTEGER = 9007199254740991, LN10_PRECISION = LN10.length - 1, PI_PRECISION = PI.length - 1,
   ...
   */
    P.comparedTo = P.cmp = function (y) {
        var x = this, xd = x.d, yd = (y = new x.constructor(y)).d, xs = x.s, ys = y.s;
   ...
   */
    P.cosine = P.cos = function () {
        ...
        Ctor.precision = pr;
        return finalise(quadrant == 2 || quadrant == 3 ? x.neg() : x, true);
    };
    /*
   *
   ...
   */
    P.cubeRoot = P.cbrt = function () {
        var e, m, rep, s, x = this, Ctor = x.constructor;
        ...
        return finalise(r, Ctor.rounding, m);
    };
    /*
   ...
   *
   */
    P.greaterThanOrEqualTo = P.gte = function () {
        var k;
        return k == 1 || k === 0;
    };
    /*
   ...
   */
    P.hyperbolicCosine = P.cosh = function () {
        var k, rm, x = this, Ctor = x.constructor, one = new Ctor(1);
        if (!x.isFinite())
   ...
   */
    P.inverseCosine = P.acos = function () {
        var x = this, Ctor = x.constructor, k;
        if (k !== -1) {
            return k === 0    // |x| is 1
 ...
 : new Ctor(NaN);
   ...
   */
    P.inverseTangent = P.atan = function () {
        var i, j, k, t, r, wpr, x2, x = this, Ctor = x.constructor, pr = Ctor.precision, rm = Ctor.rounding;
        if (!x.isFinite()) {
            if (!x.s)
                return new Ctor(NaN);
   ...
   */
    P.logarithm = P.log = function (base) {
        var isBase10, d, denominator, k, inf, num, r, arg = this, Ctor = arg.constructor;
        // Default base is 10.
        if (base == null) {
            isBase10 = true;
        } else {
        ...
        if (checkRoundingDigits(r.d, k = pr, rm)) {
            ...
            } while (checkRoundingDigits(r.d, k += 10));
        }
        return;
    };
    /*
   ...
   */
    P.minus = P.sub = function (y) {
        var e, i, j, k, len, rm, xe, xLTy, yd, x = this, Ctor = x.constructor;
        y = new Ctor(y);
   ...
   */
    P.plus = P.add = function (y) {
        var carry, d, i, k, len, pr, rm, xd, yd, x = this, Ctor = x.constructor;
        y = new Ctor(y);
        // If either is not finite...
        if (!x.d || !y.d) {
            // Return NaN if either is NaN.
   ...
   */
    P.sine = P.sin = function () {
        ...
        pr = Ctor.precision;
        Ctor.precision = pr + Math.max(x.e) + LOG_BASE;
        return finalise(quadrant > 2 ? x.neg() : x, rm, true);
    };
    /*
   ...
   */
    P.squareRoot = P.sqrt = function () {
        var m, rep, t, x = this, d = x.d, e = x.e, s = x.s, Ctor = x.constructor;
   ...
   */
    P.times = P.mul = function (y) {
        var i, k, r, rL, t, ydL, x = this, Ctor = x.constructor, xd = x.d, yd = (y = new Ctor(y)).d;
        y.s *= x.s;
 ...
 : !xd || !yd ? y.s / 0 : y.s * 0);
   ...
   */
    P.toFraction = function (maxD) {
        var d0, d1, d2, e, k, n, n0, q, r, x = this, xd = x.d, Ctor = x.constructor;
        if (!xd)
            return new Ctor(x);
        n1 = d0 = new Ctor(1);
        d1 = n0 = new Ctor(0);
   ...
   */
    function digitsToString(d) {
        var k, ws, indexOfLastWord = d.length - 1, str = '', w = d[0];
   ...
   */
    ...
    function convertBase(str, baseIn, baseOut) {
        var arr = [0], arrL, i = 0, strL = str.length;
        for (; i < strL;) {
   ...
   */
    var divide = function () {
        ...
        return function (x, y, pr, rm, dp, base) {
            var e, i, k, logBase, more, prod, prodL, qd, rem, rem0, sd, t, xi, xL, yd0, yL, yz, Ctor = x.constructor, sign = x.s == y.s ? 1 : -1, xd = x.d, yd = y.d;
   ...
   */
    function naturalLogarithm(y, sd) {
        var c, c0, denominator, e, rep, t, wpr, x1, x2, guard = 10, x = y, xd = x.d, Ctor = x.constructor, rm = Ctor.rounding, pr = Ctor.precision;
   ...
   */
    function toStringBinary(x, baseOut, sd, rm) {
        var e, i, len, roundUp, str, y, Ctor = x.constructor, isExp = sd !== void 0;
        if (isExp) {
            if (rm === void 0)
                rm = Ctor.rounding;
        } else {
