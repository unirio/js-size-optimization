 ...
 : !xd || !yd ? y.s / 0 : y.s * 0);
   ...
   */
    ...
    function convertBase(str, baseIn, baseOut) {
        var j, arr = [], arrL, strL = str.length;
        for (; i < strL;) {
   ...
   */
    var divide = function () {
        ...
        return function (x, y, pr, rm, dp, base) {
            var cmp, i, logBase, more, prod, q, rem, rem0, t, xL, yL, Ctor = x.constructor, sign = x.s == y.s ? 1 : -1, xd = x.d, yd = y.d;
   ...
   */
    ...
    function getLn10(Ctor, sd, pr) {
        ...
        return finalise(new Ctor(LN10), sd, true);
    }
   ...
   */
    function naturalLogarithm(y, sd) {
        var c, denominator, numerator, rep, sum, t, wpr, x2, guard = 10, x = y, xd = x.d, Ctor = x.constructor, rm = Ctor.rounding, pr = Ctor.precision;
        ...
        if (str) {
            ...
            if (external) {
                ...
                if (x.e > x.constructor.maxE) {
                    ...
                    x.d = [];    // x.constructor.underflow = true;
   ...
   */
    function parseOther(x, str) {
        ...
        if (p)
            x = x.times(Math.abs(p) < 54 ? Math.pow(2, p) : Decimal.pow(p));
    }
    /*
   * sin(x) = x - x^3/3! + x^5/5! - ...
   * |x| < pi/2
    ...
    function toStringBinary(x, baseOut, sd, rm) {
        ...
        if (!x.isFinite()) {
            ...
            if (i >= 0) {
                str = str.replace('.');
                y = new Ctor(1);
                y.d = convertBase(finiteToString(y), base);
            }
   ...
   */
    function config(obj) {
        ...
        var useDefaults = obj.defaults === true, ps = [
                'precision',
                1,
                MAX_DIGITS,
                'rounding',
