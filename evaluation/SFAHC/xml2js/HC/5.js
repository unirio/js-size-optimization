...
(function () {
    var bom, builder, escapeCDATA, events, isEmpty, processName, processors, requiresCDATA, sax, setImmediate, extend = function (child, parent) {
        ...
        Parser.prototype.reset = function () {
            ...
            ontext = function (_this) {
                return function (text) {
                    ...
                    if (s) {
                        s[charkey] += text;
                        if (_this.options.explicitChildren && _this.options.preserveChildrenOrder && _this.options.charsAsChildren && text.replace().trim() !== '') {
                            s[_this.options.childkey] = s[_this.options.childkey] || [];
