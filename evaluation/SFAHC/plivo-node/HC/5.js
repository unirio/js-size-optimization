...
plivo.prototype.get_live_call = function () {
    delete params.call_uuid;
    params.status = 'live';
    this.request(action, method, params, callback);
};
...
plivo.prototype.hangup_conference = function () {
    delete params.conference_id;
    var method = 'DELETE';
    this.request(callback);
};
...
plivo.prototype.create_subaccount = function (callback) {
    var action = 'Subaccount/';
    var method = 'POST';
    this.request(action, method, params, callback);
};
...
// Message
plivo.prototype.send_message = function (callback) {
    var action = 'Message/';
    var method = 'POST';
    this.request(action, params, callback);
};
