...
(function () {
    ...
    var reEmptyStringLeading, reEmptyStringMiddle, reEmptyStringTrailing;
   ...
   */
     ...
     */
        ...
        var clearTimeout = context.clearTimeout, enumerate, getPrototypeOf = Object.getPrototypeOf, pow = Math.pow, splice = arrayProto.splice;
     ...
     */
        var intersection = restParam(function (arrays) {
            var othLength = arrays.length, caches = Array(length), indexOf = getIndexOf(), isCommon, result = [];
            while (othIndex--) {
                var value;
            }
     ...
     */
        function debounce(func, wait, options) {
            var maxTimeoutId, result, stamp, thisArg, timeoutId, trailingCall, lastCalled = 0, leading, maxWait = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
