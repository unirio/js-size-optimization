...
(function () {
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Error = context.Error, Function = context.Function, Number = context.Number, RegExp = context.RegExp;
     ...
     */
        function debounce(func, wait, options) {
            var maxTimeoutId, result, stamp, timeoutId, trailingCall, leading = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
