   ...
   */
     ...
     */
        function baseDifference(array, values) {
            ...
            var index = -1, indexOf = getIndexOf(), isCommon = indexOf === baseIndexOf, cache, valuesLength = values.length;
            if (cache) {
     ...
     */
        function baseUniq(array, iteratee) {
            var index = -1, indexOf = getIndexOf(), length = array.length, isCommon, isLarge = isCommon && length >= LARGE_ARRAY_SIZE, seen = isLarge ? createCache() : null, result = [];
            if (seen) {
                indexOf = cacheIndexOf;
                isCommon = false;
            } else {
     ...
     */
        function createCtorWrapper(Ctor) {
            return function () {
                ...
                case 7:
                    return new Ctor(args[0], args[1], args[2], args[5], args[6]);
                }
     ...
     */
        function createHybridWrapper(func, bitmask, thisArg, partials, holders, partialsRight, holdersRight, argPos, ary, arity) {
            ...
            function wrapper() {
                ...
                var length = arguments.length, index = length, args = Array();
                while (index--) {
     ...
     */
        function createPartialWrapper(func, bitmask, thisArg, partials) {
            var isBind = bitmask & BIND_FLAG, Ctor;
            function wrapper() {
                // Avoid `arguments` object use disqualifying optimizations by
     ...
     */
        var intersection = restParam(function (arrays) {
            ...
            var array = arrays[0], index = -1, length = array ? array.length : 0, seen;
            outer:
                while (++index < length) {
                    value = array[index];
     ...
     */
        function keys(object) {
            ...
            for (var key in object) {
                if (hasOwnProperty.call(object, key) && !(skipIndexes && isIndex(key)) && !(isProto && key == 'constructor')) {
                    result.push(key);
                }
            }
            return result;
