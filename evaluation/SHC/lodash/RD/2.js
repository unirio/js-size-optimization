...
(function () {
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Date = context.Date, Error = context.Error, Function = context.Function, Math = context.Math, Number = context.Number, Object = context.Object, RegExp = context.RegExp, String = context.String;
     ...
     */
        function baseIsEqualDeep(object, other, equalFunc, customizer, isLoose, stackA, stackB) {
            var objIsArr = isArray(object), othIsArr = isArray(), objTag = arrayTag, othTag = arrayTag;
            if (!objIsArr) {
        ...
        function baseIsMatch(object, source, matchData, customizer) {
            ...
            while (++index < length) {
                ...
                if (noCustomizer && data[2]) {
                    ...
                    if (!(result === undefined ? baseIsEqual(srcValue, objValue, customizer, true, stackB) : result)) {
                        return false;
                    }
                }
            }
     ...
     */
        function baseSortByOrder(collection, iteratees, orders) {
            ...
            var result = baseMap(collection, function (value, key) {
     ...
     */
        function createCtorWrapper(Ctor) {
            return function () {
                ...
                case 5:
                    return new Ctor(args[0], args[2], args[3], args[4]);
                case 6:
                    return new Ctor(args[0], args[1], args[2], args[3], args[4], args[5]);
                case 7:
                    return new Ctor(args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
                }
                var thisBinding = baseCreate(), result = Ctor.apply(thisBinding, args);
     ...
     */
        function hasPath(object, path, hasFunc) {
            ...
            return result || isLength(object && object.length) && isIndex(path) && (isArray(object) || isArguments() || isString(object));
        }
        /**
     ...
     */
        function fill(array, value, start, end) {
            ...
            if (start && typeof start != 'number' && isIterateeCall(array, value)) {
                start = 0;
                end = length;
            }
     ...
     */
        var invoke = restParam(function (collection, path, args) {
            var index = -1, isFunc = typeof path == 'function', isProp = isKey(path), result = isArrayLike(collection) ? Array() : [];
     ...
     */
        function debounce(func, wait, options) {
            var args, maxTimeoutId, result, stamp, timeoutId, trailingCall, lastCalled = 0, leading = false, maxWait = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
     ...
     */
        function valuesIn(object) {
            return object == null ? baseValues(object, keysIn()) : [];
        }
        /*------------------------------------------------------------------------*/
        /**
