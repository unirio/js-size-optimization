...
(function () {
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Date = context.Date, Error = context.Error, Function = context.Function, Math = context.Math, Number = context.Number, RegExp = context.RegExp, TypeError = context.TypeError;
        ...
        function baseIsEqualDeep(object, other, equalFunc, customizer, isLoose, stackA, stackB) {
            ...
            if (!isLoose) {
                ...
                if (objIsWrapped || othIsWrapped) {
                    return equalFunc(objIsWrapped ? object.value() : object, othIsWrapped ? other.value() : other, customizer, isLoose, stackB);
                }
            }
            if (!isSameTag) {
                return false;
            ...
            return function (collection, iteratee) {
                ...
                if (isArray(collection)) {
                    ...
                    baseEach(collection, function (value, key) {
                        setter(result, value, iteratee(value, key, collection));
                    });
                }
                return result;
            };
     ...
     */
        function createCtorWrapper(Ctor) {
            return function () {
                ...
                case 5:
                    return new Ctor(args[0], args[1], args[3], args[4]);
                case 6:
     ...
     */
        function hasPath(object, path, hasFunc) {
            ...
            return result || isLength(object && object.length) && isIndex(path, object.length) && (isArray(object) || isArguments(object) || isString());
        }
        /**
     ...
     */
        function every(collection, predicate, guard) {
            var func = isArray() ? arrayEvery : baseEvery;
     ...
     */
        var invoke = restParam(function (collection, path, args) {
            var index = -1, isFunc = typeof path == 'function', isProp = isKey(), result = isArrayLike(collection) ? Array(collection.length) : [];
     ...
     */
        function map(collection, iteratee) {
            var func = isArray() ? arrayMap : baseMap;
     ...
     */
        function debounce(func, wait, options) {
            var args, maxTimeoutId, result, stamp, thisArg, timeoutId, trailingCall, lastCalled = 0, leading = false, maxWait, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
     ...
     */
        function random(min, max, floating) {
            if (floating && isIterateeCall(min, floating)) {
     ...
     */
        ...
        arrayEach(['initial'], function (methodName, index) {
