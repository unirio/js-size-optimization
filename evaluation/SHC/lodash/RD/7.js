...
(function () {
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Date = context.Date, Error = context.Error, Function = context.Function, Math = context.Math, Object = context.Object, RegExp = context.RegExp, TypeError = context.TypeError;
     ...
     */
        function createCtorWrapper(Ctor) {
            return function () {
                ...
                case 6:
                    return new Ctor(args[0], args[1], args[3], args[4], args[5]);
                case 7:
     ...
     */
        function mergeDefaults(objValue, srcValue, key, object, source, stackA, stackB) {
            if (isObject(objValue)) {
                ...
                baseMerge(objValue, srcValue, mergeDefaults, stackA);
            }
            return objValue === undefined ? srcValue : objValue;
        }
        /**
