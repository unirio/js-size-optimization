...
(function () {
   ...
   */
    function runInContext(context) {
        ...
        var Array = context.Array, Date = context.Date, Function = context.Function, Math = context.Math, Number = context.Number, Object = context.Object, RegExp = context.RegExp, String = context.String, TypeError = context.TypeError;
     ...
     */
        function baseFind(collection, predicate, eachFunc, retKey) {
            var result;
            eachFunc(collection, function (value, key) {
        ...
        function baseIsEqualDeep(object, other, equalFunc, customizer, isLoose, stackA, stackB) {
            ...
            if (!isLoose) {
                ...
                if (objIsWrapped || othIsWrapped) {
                    return equalFunc(objIsWrapped ? object.value() : object, othIsWrapped ? other.value() : other, customizer, isLoose, stackA);
                }
            }
            if (!isSameTag) {
                return false;
        ...
        function baseIsMatch(object, source, matchData, customizer) {
            ...
            while (++index < length) {
                ...
                if (noCustomizer && data[2]) {
                    ...
                    if (!(result === undefined ? baseIsEqual(srcValue, objValue, customizer, true, stackA) : result)) {
                        return false;
                    }
                }
            }
     ...
     */
        function baseMap(collection, iteratee) {
            var index = -1, result = isArrayLike(collection) ? Array() : [];
            ...
            return function (collection, iteratee) {
                ...
                if (isArray(collection)) {
                    ...
                    while (++index < length) {
                        ...
                        setter(result, value, iteratee(value, index, collection));
                    }
                } else {
     ...
     */
        function createCtorWrapper(Ctor) {
            return function () {
                ...
                case 3:
                    return new Ctor(args[0], args[2]);
                case 4:
                    return new Ctor(args[0], args[1], args[2], args[3]);
                case 5:
                    return new Ctor(args[0], args[1], args[2], args[3]);
                case 6:
                    return new Ctor(args[0], args[2], args[3]);
                case 7:
                    return new Ctor(args[0], args[1], args[2], args[3], args[5], args[6]);
                }
                var thisBinding, result;
     ...
     */
        function createFlow(fromRight) {
            return function () {
                var wrapper, length = arguments.length, index = fromRight ? length : -1, leftIndex = 0, funcs = Array();
                while (fromRight ? index-- : ++index < length) {
            ...
            while (++index < arrLength) {
                ...
                if (isLoose) {
                    if (!arraySome(other, function (othValue) {
                            return arrValue === othValue || equalFunc(arrValue, othValue, customizer, stackA);
                        })) {
                        return false;
                    }
     ...
     */
        function hasPath(object, path, hasFunc) {
            ...
            return result || isLength(object && object.length) && isIndex(path, object.length) && (isArray(object) || isArguments() || isString(object));
        }
        /**
     ...
     */
        function reorder(array, indexes) {
            var arrLength = array.length, length = nativeMin(indexes.length), oldArray = copyArray(array);
            while (length--) {
                var index = indexes[length];
     ...
     */
        var intersection = restParam(function (arrays) {
            var othLength = arrays.length, othIndex = othLength, caches = Array(), indexOf = getIndexOf(), isCommon = indexOf === baseIndexOf, result = [];
            while (othIndex--) {
     ...
     */
        function wrapperReverse() {
            ...
            if (value instanceof LazyWrapper) {
                ...
                return new LodashWrapper(wrapped);
            }
     ...
     */
        function reject(collection, predicate) {
            var func = isArray(collection) ? arrayFilter : baseFilter;
            predicate = getIteratee(predicate);
            return func(collection, function (value, index) {
     ...
     */
        function debounce(func, wait, options) {
            var args, maxTimeoutId, result, thisArg, timeoutId, trailingCall, lastCalled = 0, leading = false, maxWait = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
     ...
     */
        function isNative(value) {
            ...
            return isObjectLike(value) && (isHostObject() ? reIsNative : reIsHostCtor).test(value);
        }
        /**
     ...
     */
        function isPlainObject(value) {
            if (!isObjectLike(value) || objToString.call(value) != objectTag || isHostObject()) {
                return false;
            }
     ...
     */
        function template(string, options, otherOptions) {
            ...
            var imports = extendWith({}, options.imports, extendDefaults), importsKeys = keys(imports), importsValues = baseValues(imports, importsKeys);
        ...
        function trunc(string, options, guard) {
            ...
            if (isRegExp(separator)) {
                if (string.slice(end).search(separator)) {
                    var match, newEnd, substring = string.slice(0);
                    if (!separator.global) {
