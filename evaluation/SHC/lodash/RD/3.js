   ...
   */
        ...
        function createCtorWrapper(Ctor) {
            return function () {
                ...
                case 6:
                    return new Ctor(args[0], args[1], args[2], args[3], args[4]);
                case 7:
                    return new Ctor(args[0], args[1], args[2], args[4], args[5], args[6]);
                }
            };
        }
        /**
     ...
     */
        function debounce(func, wait, options) {
            var args, maxTimeoutId, result, stamp, thisArg, timeoutId, trailingCall, lastCalled = 0, leading, maxWait = false, trailing = true;
            if (typeof func != 'function') {
                throw new TypeError(FUNC_ERROR_TEXT);
            }
     ...
     */
        ...
        realNames[createHybridWrapper(undefined).name] = [];
