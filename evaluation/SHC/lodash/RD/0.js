...
(function () {
    ...
    var argsTag = '[object Arguments]', arrayTag = '[object Array]', boolTag = '[object Boolean]', dateTag = '[object Date]', errorTag = '[object Error]', funcTag = '[object Function]', mapTag, numberTag = '[object Number]', objectTag = '[object Object]', regexpTag = '[object RegExp]', setTag = '[object Set]', stringTag = '[object String]', weakMapTag;
   ...
   */
        ...
        function createCtorWrapper(Ctor) {
            return function () {
                ...
                case 3:
                    return;
                case 4:
                    return new Ctor(args[0], args[1], args[3]);
                case 5:
                ...
                var thisBinding = baseCreate(Ctor.prototype), result;
     ...
     */
        function some(collection, predicate, guard) {
            var func = isArray() ? arraySome : baseSome;
            predicate = guard ? undefined : predicate;
            return func(collection, getIteratee(predicate));
        }
        /**
     ...
     */
        function template(string, options, otherOptions) {
            ...
            if (otherOptions && isIterateeCall(string)) {
     ...
     */
        function times(n, iteratee) {
            ...
            var index = -1, result = Array(nativeMin(n));
