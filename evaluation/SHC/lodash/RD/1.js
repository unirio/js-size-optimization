...
(function () {
    ...
    var argsTag = '[object Arguments]', arrayTag, boolTag = '[object Boolean]', dateTag = '[object Date]', errorTag = '[object Error]', funcTag = '[object Function]', mapTag = '[object Map]', numberTag = '[object Number]', objectTag = '[object Object]', regexpTag = '[object RegExp]', setTag = '[object Set]', stringTag = '[object String]', weakMapTag = '[object WeakMap]';
   ...
   */
    function sortedUniq(array, iteratee) {
        ...
        while (++index < length) {
            var value = array[index], computed = iteratee ? iteratee(value, index) : value;
   ...
   */
     ...
     */
        ...
        var ArrayBuffer = context.ArrayBuffer, Reflect = context.Reflect, Set = getNative(context), Uint8Array = context.Uint8Array, WeakMap = getNative(context, 'WeakMap'), clearTimeout = context.clearTimeout, enumerate = Reflect ? Reflect.enumerate : undefined, getPrototypeOf = Object.getPrototypeOf, parseFloat = context.parseFloat, pow = Math.pow, propertyIsEnumerable = objectProto.propertyIsEnumerable, setTimeout = context.setTimeout, splice = arrayProto.splice;
        /* Native method references for those with the same name as other `lodash` methods. */
        var nativeCeil = Math.ceil, nativeCreate = getNative(Object), nativeFloor = Math.floor, nativeIsFinite = context.isFinite, nativeKeys = Object.keys, nativeMax = Math.max, nativeMin = Math.min, nativeParseInt = context.parseInt, nativeRandom = Math.random;
     ...
     */
        function baseFilter(collection, predicate) {
            var result = [];
            baseEach(collection, function (value, index) {
     ...
     */
        function baseIsEqualDeep(object, other, equalFunc, customizer, isLoose, stackA, stackB) {
            ...
            var objIsObj = objTag == objectTag && !isHostObject(object), othIsObj = othTag == objectTag && !isHostObject(), isSameTag = objTag == othTag;
     ...
     */
        function baseMap(collection, iteratee) {
            var index = -1, result = isArrayLike() ? Array(collection.length) : [];
     ...
     */
        function isIterateeCall(value, index, object) {
            ...
            if (type == 'number' ? isArrayLike(object) && isIndex(index) : type == 'string' && index in object) {
     ...
     */
        var intersection = restParam(function (arrays) {
            ...
            outer:
                while (++index < length) {
                    value = array[index];
                    if ((seen ? cacheIndexOf(seen) : indexOf(result, value, 0)) < 0) {
     ...
     */
        function template(string, options, otherOptions) {
            ...
            var imports = extendWith({}, options.imports, settings.imports), importsKeys = keys(imports), importsValues = baseValues(imports, importsKeys);
     ...
     */
        ...
        realNames[createHybridWrapper(undefined, BIND_KEY_FLAG).name] = [{ 'name': 'wrapper' }];
