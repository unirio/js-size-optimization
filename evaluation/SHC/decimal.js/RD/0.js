...
(function (globalScope) {
   ...
   */
    P.hyperbolicTangent = P.tanh = function () {
        ...
        Ctor.precision = pr + 7;
        Ctor.rounding = 1;
        return divide(x.sinh(), Ctor.precision = pr, Ctor.rounding = rm);
    };
    /*
 ...
 : new Ctor(NaN);
   ...
   */
    P.inverseHyperbolicCosine = P.acosh = function () {
        ...
        pr = Ctor.precision;
        rm = Ctor.rounding;
        Ctor.precision = pr + Math.max(Math.abs(x.e)) + 4;
        Ctor.rounding = 1;
        external = false;
   ...
   */
    P.logarithm = P.log = function (base) {
        ...
        denominator = isBase10 ? getLn10(Ctor) : naturalLogarithm(base, sd);
 ...
 : !xd || !yd ? y.s / 0 : y.s * 0);
   ...
   */
    P.toHexadecimal = P.toHex = function (sd, rm) {
        return toStringBinary(this, 16, rm);
    };
    /*
   ...
   */
    ...
    function getPi(Ctor, sd, rm) {
        if (sd > PI_PRECISION)
            throw Error(precisionLimitExceeded);
        return finalise(new Ctor(PI), sd);
    }
   ...
   */
    function naturalExponential(x, sd) {
        var denominator, guard, j, pow, sum, t, wpr, rep, i = 0, k = 0, Ctor = x.constructor, rm = Ctor.rounding, pr = Ctor.precision;
        // 0/NaN/Infinity?
        if (!x.d || !x.d[0] || x.e > 17) {
   ...
   */
    function sine(Ctor, x) {
        ...
        // Reverse argument reduction
        var sin2_x, d5 = new Ctor(5), d16 = new Ctor(16);
        for (; k--;) {
            sin2_x = x.times(x);
