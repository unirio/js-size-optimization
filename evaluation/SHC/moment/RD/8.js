...
(function (global, factory) {
    ...
    addRegexToken('YYYYYY', match1to6);
    addParseToken([
        'YYYYY',
        'YYYYYY'
    ], YEAR);
    ...
    function configFromStringAndFormat(config) {
        ...
        var string = '' + config._i, i, parsedInput, tokens, skipped, stringLength = string.length, totalParsedInputLength = 0;
 ...
 */
    ...
    function bubble() {
        ...
        var data = this._data;
        var seconds, minutes, years, monthsFromDays;
