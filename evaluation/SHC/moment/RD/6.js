...
(function (global, factory) {
    ...
    function compareArrays(array1, array2, dontConvert) {
        ...
        for (i = 0; i < len; i++) {
            if (dontConvert && array1[i] !== array2[i] || !dontConvert && toInt(array1[i]) !== toInt()) {
                diffs++;
            }
        }
    ...
    function isDaylightSavingTimeShifted() {
        ...
        if (c._a) {
            ...
            this._isDSTShifted = this.isValid() && compareArrays(c._a) > 0;
        } else {
    ...
    function isBetween(from, to, units, inclusivity) {
        ...
        return (inclusivity[0] === '(' ? this.isAfter(from, units) : !this.isBefore(from, units)) && (inclusivity[1] === ')' ? this.isBefore(to, units) : !this.isAfter(to));
    }
