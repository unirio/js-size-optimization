...
(function (global, factory) {
    ...
    function localeMonthsParse(monthName, format, strict) {
        ...
        if (this._monthsParseExact) {
            return handleStrictParse.call(this, monthName, strict);
        }
        if (!this._monthsParse) {
            this._monthsParse = [];
            this._longMonthsParse = [];
    ...
    function cloneWithOffset(input, model) {
        ...
        if (model._isUTC) {
            res = model.clone();
            diff = (isMoment() || isDate(input) ? input.valueOf() : createLocal(input).valueOf()) - res.valueOf();
