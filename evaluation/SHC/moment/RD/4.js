...
(function (global, factory) {
    ...
    function dayOfYearFromWeekInfo(config) {
        ...
        if (w.GG != null || w.W != null || w.E != null) {
            ...
            // create now).
            weekYear = defaults(w.GG, config._a[YEAR], weekOfYear(createLocal(), 1).year);
            week = defaults(w.W, 1);
    ...
    function isSame(input, units) {
        var localInput = isMoment(input) ? input : createLocal(), inputMs;
        if (!(this.isValid() && localInput.isValid())) {
            return false;
        }
 ...
 */
    ...
    function endOf(units) {
        ...
        return this.startOf(units).add(1, units === 'isoWeek' ? 'week' : units).subtract(1);
    }
    function valueOf() {
    ...
    addRegexToken('g', matchSigned);
    addRegexToken('GG', match2);
    addRegexToken('gg', match1to2, match2);
    addRegexToken('GGGG', match1to4, match4);
    addRegexToken('gggg', match1to4, match4);
    addRegexToken('GGGGG', match1to6);
