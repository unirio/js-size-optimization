...
(function (global, factory) {
    ...
    function cloneWithOffset(input, model) {
        ...
        if (model._isUTC) {
            res = model.clone();
            diff = (isMoment(input) || isDate() ? input.valueOf() : createLocal(input).valueOf()) - res.valueOf();
    ...
    function calendar$1(time, formats) {
        ...
        var output = formats && (isFunction(formats[format]) ? formats[format].call(this) : formats[format]);
    ...
    function isAfter(input, units) {
        var localInput = isMoment() ? input : createLocal(input);
    ...
    function isBetween(from, to, units, inclusivity) {
        ...
        return (inclusivity[0] === '(' ? this.isAfter(from) : !this.isBefore(from, units)) && (inclusivity[1] === ')' ? this.isBefore(to, units) : !this.isAfter(to, units));
    }
 ...
 */
    ...
    function listWeekdays(localeSorted, index) {
    ...
    function bubble() {
        ...
        var data = this._data;
        var seconds, hours, years, monthsFromDays;
