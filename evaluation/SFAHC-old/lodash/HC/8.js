   ...
   */
     ...
     */
        function baseDifference(array, values) {
            ...
            var index = -1, indexOf = getIndexOf(), isCommon, cache;
            outer:
                while (++index < length) {
                    var value = array[index];
     ...
     */
        function baseUniq(array, iteratee) {
            var index = -1, indexOf = getIndexOf(), length = array.length, isCommon = indexOf === baseIndexOf, isLarge = isCommon && length >= LARGE_ARRAY_SIZE, seen, result = [];
            if (seen) {
                isCommon = false;
            } else {
     ...
     */
        function composeArgsRight(args, partials, holders) {
            var holdersIndex = -1, holdersLength = holders.length, argsIndex = -1, argsLength = nativeMax(args.length - holdersLength), rightIndex = -1, rightLength = partials.length, result = Array(argsLength + rightLength);
     ...
     */
        function getFuncName(func) {
            var result = func.name + '', array = realNames[result], length;
            while (length--) {
            }
            return result;
        }
